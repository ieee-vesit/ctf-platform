...
const TeamAvatar = ({ avatar, name, size = "default" }) => {
  const sizeClasses =
    size === "small" ? "w-8 h-8 text-sm" : "w-10 h-10 text-lg";
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-2 text-gray-400 mt-2">
            ...
            <span className="text-sm">
              {TOTAL_TEAMS} Participating Teams
            </span>
          </div>
        </div>
            ...
            >
              ...
              <div className="flex justify-between items-center pt-3 border-t border-zinc-800">
                <span className="text-gray-400 text-sm">
                  {team.challengesSolved}/{team.totalChallenges} solved
                </span>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-8 text-sm">
          <div className="text-gray-400">
            ...
            <span className="text-yellow-400 font-medium">
              {startIndex + 1}-{Math.min(endIndex, TOTAL_TEAMS)}
            </span>{" "}
            of <span className="font-medium">{TOTAL_TEAMS}</span>
          </div>
